...
// Описание:
//      Намира броя четни числа в даден масив.
// Входни параметри на функцията:
//     -const int array[] - указател към масив
//     -const int array_length - големината на масива
// Връщан резултат:
//     -int count - брой четни числа в даден масив
...
// Описание:
//      Намира броя нечетни числа в даден масив.
// Входни параметри на функцията:
//     -const int array[] - указател към масив
//     -const int array_length - големината на масива
// Връщан резултат:
//     -int count - брой нечетни числа в даден масив
...
bool monotonic_increasing(const int array[], const int array_length){
